Google KMS is currently not used
...
java -jar jsign-7.1.jar --storetype GOOGLECLOUD --keystore projects/key-managment-464714/locations/global/keyRings/codesigning --storepass %GCP_ACCESS_TOKEN% --alias cs2022-3 --certfile cs2022cert.pem -t http://timestamp.digicert.com application.exe
````
...
```` 
>gcloud iam service-accounts create my-federated-service-account --project key-managment-464714
````

### Bind to to external user
```` 
gcloud iam service-accounts add-iam-policy-binding my-federated-service-account@key-managment-464714.iam.gserviceaccount.com --member "principalSet://iam.googleapis.com/projects/399559717351/locations/global/workloadIdentityPools/githubaction/attribute.repository_owner/rjungbeck" --role roles/iam.serviceAccountUser --project key-managment-464714
````

### Grant rights to user
```` 
gcloud kms keys add-iam-policy-binding cs2022-3 --location global --keyring codesigning --member serviceAcount:my-federated-service-account@key-managment-464714.iam.gserviceaccount.com --role roles/cloudkms.viewer --project key-managment-464714
gcloud kms keys add-iam-policy-binding cs2022-3 --location global --keyring codesigning --member serviceAcount:my-federated-service-account@key-managment-464714.iam.gserviceaccount.com --role roles/cloudkms.signer --project key-managment-464714
````